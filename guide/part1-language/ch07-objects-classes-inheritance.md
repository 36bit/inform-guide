...
| Maximum classes | 256, including the four built-in metaclasses (`Class`, `Object`, `Routine`, `String`); on v3 this is further bounded by the 255-object cap that classes share with all other objects | 32768 (every class is an object and consumes an object-number slot) |
